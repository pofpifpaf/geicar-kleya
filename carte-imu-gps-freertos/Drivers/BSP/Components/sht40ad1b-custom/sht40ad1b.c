 ...
 * @retval 0 in case of success, an error code otherwise
 *
 * @warning this function must be called before reading humidity value 10 ms later
 */
int32_t SHT40AD1B_HUM_StartMeasurement(SHT40AD1B_Object_t *pObj) {

	if (sht40ad1b_start_measurements(&(pObj->Ctx)) != SHT40AD1B_OK)
	{
		return SHT40AD1B_ERROR;
	}
 ...
 * @retval 0 in case of success, an error code otherwise
 *
 * @warning this function must be called 10ms later after SHT40AD1B_HUM_StartMeasurement
 */
